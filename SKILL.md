---
name: flux-image
description: Generate images using Flux (Black Forest Labs) via Atlas Cloud API. $0.012/image, LoRA support, NSFW mode, inpainting. Use when user asks to "generate an image with Flux" or "create a cheap AI image".
---
# Flux Image Skill
